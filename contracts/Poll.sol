...
contract Poll {
    ...
    mapping(uint256 => Option[]) public PollsOptions;
    ...
    function createPoll(
        ...
        pollData.pollId = latestCreatedPoll.current();
        ...
        for (uint256 i = 0; i < _optionNames.length; i++) {
            ...
            PollsOptions[latestCreatedPoll.current()].push(options[i]);
        }
